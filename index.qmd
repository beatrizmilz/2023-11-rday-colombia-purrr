...
- Remember: to use `map()`, we need a vector or a list of the elements that we want to apply the function + a function.

## Example

- Let's start with the vector of files that we want to import:
